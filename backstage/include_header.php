  ...
  <title>
    <?php 
      if(ISSET($page_title)){
        ...
        echo 'Backstage: Pull Up a Chair';
      }
    ?>
    </title>
...
<!-- DETERMINE HEADER LOGO -->
  ...
  <script type="text/javascript">
    ...
    var Logo  = '<a href="home.php"><img class="main" alt="logo" src="images/masthead_small.jpg"><br /><img class="tagline" src="images/tagline.png"></a>';
  }
  else{
    var Style = '<link rel="stylesheet" type="text/css" href="mobile_styles.css">';
    var Logo  = '<a href="home.php"><img class="main" alt="logo" src="images/masthead_large.jpg"></a>';
  }
