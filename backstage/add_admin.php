...
<title>Backstage: Pull Up a Chair</title>
...
<link rel="stylesheet" type="text/css" href="backstage_styles.css">
...
<p class="label"><label for="first_name">First Name</label> <input name="first_name" type="text"></p>
<p class="label"><label for="last_name">Last Name</label> <input name="last_name" type="text"></p>
<p class="label"><label for="email">Email</label> <input name="email" type="text"></p>
<p class="label"><label for="password1">Password</label> <input name="password1" type="password"></p>
<p class="label"><label for="email">Verify Password</label> <input name="password2" type="password"></p>
