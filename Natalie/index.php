...
if(isMobile == true){
  ...
  var Logo  = '<img class="main" src="images/masthead_small.jpg"><br /><img class="tagline" src="images/tagline.png">';
  ...
  var Style = '<link rel="stylesheet" type="text/css" href="mobile_styles.css">';
  var Logo  = '<img class="main" src="images/masthead_large.jpg">';
...
<h1>Natalie's Playground!</h1>
<p>Natalie can use this space to make any sort of webpage or web-based program that she wants.</p>
<p>She can create sites using HTML and program in Javascript, PHP, Python or Ruby on Rails.  It's all included with your website hosting and nothing she posts here can affect your website.</p>
